...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.Book", b =>
                {
                    ...
                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_books_owner_id");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.DictionaryWord", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_dictionary_words_user_id");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.TotalReadingTime", b =>
                {
                    b.Property<Guid>("BookId")
                        .HasColumnType("uuid")
                        .HasColumnName("book_id");
                    ...
                    b.HasKey("BookId", "TicketId")
                        .HasName("pk_total_reading_times");

                    b.HasIndex("TicketId")
                        .HasDatabaseName("ix_total_reading_times_ticket_id");

                    b.ToTable("total_reading_times", (string)null);
                });
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.Book", b =>
                {
                    b.HasOne("BookManager.Domain.Entities.User", "Owner")
                        .WithMany("Books")
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_books_users_owner_id");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.DictionaryWord", b =>
                {
                    b.HasOne("BookManager.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_dictionary_words_users_user_id");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.TotalReadingTime", b =>
                {
                    b.HasOne("BookManager.Domain.Entities.Book", "Book")
                        .WithMany("TotalReadingTimes")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_total_reading_times_books_book_id");

                    b.HasOne("BookManager.Domain.Entities.Ticket", "Ticket")
                        .WithMany()
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_total_reading_times_tickets_ticket_id");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.Book", b =>
                {
                    ...
                    b.Navigation("TotalReadingTimes");
                });
