...
export class TextProcessingService {
  ...
  public translate(
    ...
    return this._client.post<TranslationResponseDto>(
      `${this._url}/translate`,
      request
    );
  }
  ...
  public detectLanguage(
    request: DetectLanguageRequestDto
  ): Observable<DetectLanguageResponseDto> {
    return this._client.post<DetectLanguageResponseDto>(
